...
public class ListenESPBrdWidgetSer extends IntentService {
    private static final String TAG = ListenESPBrdWidgetSer.class.getSimpleName();
     ...
     */
    public ListenESPBrdWidgetSer(String name) {
        super(name);
    }

    public ListenESPBrdWidgetSer() {
        super(TAG);
    }
...
//            Utils.printLog(TAG," Heart Beat Ack :- "+hbAck);
    ...
    private String getHBAckMsg() {
        try {
            ...
            jsonObject.put("rc", ++HBWidgetTask.countACK);
...
//                startTimer(messageStr);
            ...
            String msg=e.getMessage()+" Ip Address "+Utils.getDeviceIpAddress(this)+" BroadCast Address "+inetAddress.getHostAddress()+" Port : "+Constants.Connection.PORT_NO;
            Utils.createNotification(this,"Irrigation App",msg);
            EspErrorListReceiver.sendBroadcast(this,msg);
//            startTimer(messageStr);
            if(socket!=null){
...
//        }
    ...
    private void initializeTimerTask(final String msg){
        ...
        timerTask = new TimerTask() {
            public void run() {
                if(HBWidgetTask.countHB<=0) {
                    if(countRetryMsgBroadcast>2){
//                        EspNetCommMsgReceiver.sendBroadcast(ListenESPBrdWidgetSer.this, getString(R.string.msg_unable_to_connect));
                        isListen=false;
...
//                        sendBroadcast(msg);
//                        String errorMsg="Retry count " + countRetryMsgBroadcast + " For Send Hello Message Ip Address " + Utils.getDeviceIpAddress(ListenESPBrdWidgetSer.this) + " BroadCast Address " + inetAddress.getHostAddress() + " Port : "+Constants.Connection.PORT_NO;
//                        Utils.createNotification(ListenESPBrdWidgetSer.this, "Irrigation App", errorMsg);
//                        EspErrorListReceiver.sendBroadcast(ListenESPBrdWidgetSer.this,errorMsg);
//                        EspNetCommMsgReceiver.sendBroadcast(ListenESPBrdWidgetSer.this, getString(R.string.msg_waiting_for_response));
                    }
                }
            }
        };
    ...
    public void onDestroy() {
        ...
        ListenESPBrdWidgetSer.super.onDestroy();
    }
